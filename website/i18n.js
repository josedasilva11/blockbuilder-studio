...
const DICT = {
  en: {
    ...
    // === Support &amp; licence section on the landing =====================
    'landing.support.eyebrow':'Support &amp; licence',
    'landing.support.h2':     'Free forever.<br><span class="serif">Three ways to give back.</span>',
    'landing.support.p':      'BlockBuilder Studio is a one-person project. It will always work for free. If it earns its place on your machine, here\'s how to keep it alive.',
    'landing.support.t1.name':'Use it free',
    'landing.support.t1.unit':'/ forever',
    'landing.support.t1.sub': 'Hobby, learning, home prints, classroom, no account, no time limit, every feature.',
    'landing.support.t1.li1': 'Every feature unlocked',
    'landing.support.t1.li2': 'Unlimited STL &middot; OBJ &middot; STEP exports',
    'landing.support.t1.li3': 'Free updates forever',
    'landing.support.t1.li4': 'Soft reminder every 25 launches',
    'landing.support.t1.cta': 'Download free',
    'landing.support.t2.name':'Buy me a coffee',
    'landing.support.t2.unit':'one-off &middot; any amount',
    'landing.support.t2.sub': 'For the personal users who want to chip in. No commercial rights, just a thank-you that keeps the project going.',
    'landing.support.t2.li1': 'Pick any amount you like (&euro;3, &euro;5, &euro;10&hellip;)',
    'landing.support.t2.li2': 'Funds new features and bug fixes',
    'landing.support.t2.li3': 'One-time, no subscription, no account',
    'landing.support.t2.li4': 'Honest thanks, not licensing',
    'landing.support.t2.cta': '&#x2615; Buy me a coffee',
    'landing.support.t3.name':'Commercial licence',
    'landing.support.t3.unit':'once &middot; lifetime',
    'landing.support.t3.sub': 'If you sell prints, freelance, or use it for paid work. Also the highest tier of support.',
    'landing.support.t3.li1': '<strong>Commercial-use rights</strong>, sell, freelance, agency',
    'landing.support.t3.li2': 'Silences the in-app soft reminder',
    'landing.support.t3.li3': 'Priority email support &middot; 48h reply',
    'landing.support.t3.li4': 'Every machine you own, lifetime updates',
    'landing.support.t3.li5': '<strong>Funds the next features</strong>, same as coffee, bigger pour',
    'landing.support.t3.cta': 'Buy licence, &euro;12',
    'landing.support.why':    '<strong>Why ask at all?</strong> BlockBuilder Studio is built by one person on evenings and weekends. No VC money, no analytics-funded sale of your data, no upsells. The &euro;12 licence and the coffees are how it stays alive without becoming WinRAR (you know the dialog). Pick whichever feels right for how you use it.',

    // === Download section (landing) =====================================
    'landing.dl.eyebrow':     'Download &middot; v0.6.0-beta1 &middot; ~105 MB',
    'landing.dl.h2':          'Pick your OS.<br><span class="serif">One click. Sixty seconds.</span>',
    'landing.dl.p':           'No email, no signup, no waitlist. The download starts immediately.',
    'landing.dl.mobile.h':    'On a phone or tablet?',
    'landing.dl.mobile.p':    'Skip the download, open the app straight in the browser:',
    'landing.dl.mobile.cta':  'Open BlockBuilder in browser &rarr;',
    'landing.dl.mobile.note': 'Tablet + phone-optimised. Works offline after first visit. Add to Home Screen for an app icon.',
    'landing.dl.win.os':      'Windows 10 &middot; 11',
    'landing.dl.win.file':    'BlockBuilderStudio-v0.6.0-beta1-portable.zip',
    'landing.dl.win.meta':    '105 MB &middot; Portable &middot; Unzip and run',
    'landing.dl.mac.os':      'macOS 12+',
    'landing.dl.mac.file':    'Coming soon',
    'landing.dl.mac.meta':    'Universal &middot; Intel + Apple Silicon',
    'landing.dl.linux.os':    'Linux x64',
    'landing.dl.linux.file':  'Coming soon',
    'landing.dl.linux.meta':  'AppImage &middot; No install',
    'landing.dl.foot':        '<span class="mono" style="color: var(--text-mid);">v0.6.0</span> &middot; Released June 2026 &middot; Source on <a href="https://github.com/josedasilva11/blockbuilder-studio" target="_blank" rel="noopener">GitHub</a> &middot; <a href="/changelog">Changelog &rarr;</a>',
    'landing.dl.smart':       'Windows SmartScreen may show a warning on first launch (binary not yet code-signed). Click <strong>More info &rarr; Run anyway</strong>. <a href="https://github.com/josedasilva11/blockbuilder-studio#why-the-smartscreen-warning" target="_blank" rel="noopener">Why?</a>',
    'landing.dl.sys.win.h':   'Windows',
    'landing.dl.sys.win.p':   '10 / 11 &middot; x64 &middot; 4 GB RAM &middot; WebGL2 (most onboard graphics from 2015+)',
    'landing.dl.sys.mac.h':   'macOS',
    'landing.dl.sys.mac.p':   '12 Monterey or later &middot; Intel x64 or Apple Silicon (M1+)',
    'landing.dl.sys.linux.h': 'Linux',
    'landing.dl.sys.linux.p': 'Ubuntu 22.04+ / Fedora 38+ / Arch / any distro with FUSE',
    'landing.dl.post.h':      'After the download, three steps',
    'landing.dl.post.s1.h':   'Extract the .zip',
    'landing.dl.post.s1.p':   'Right-click <code>BlockBuilderStudio-v0.6.0-beta1-portable.zip</code> &rarr; <strong>Extract All&hellip;</strong> (or use 7-Zip). Pick any folder, Desktop, Documents, anywhere with write access.',
    'landing.dl.post.s2.h':   'Run BlockBuilder Studio.exe',
    'landing.dl.post.s2.p':   'Open the extracted <code>BlockBuilderStudio</code> folder. Double-click <strong>BlockBuilder Studio.exe</strong>. On first launch Windows SmartScreen may say <em>"Windows protected your PC"</em>, click <strong>More info &rarr; Run anyway</strong>.',
    'landing.dl.post.s3.h':   'That\'s it, start modeling',
    'landing.dl.post.s3.p':   'No installer. Nothing in <code>Program Files</code>, no registry keys, no shortcuts unless you make one. To uninstall: delete the folder. To update: download the next release and replace it.',
    'landing.dl.post.tip':    '<strong>Want a desktop shortcut?</strong> Right-click <code>BlockBuilder Studio.exe</code> &rarr; <em>Send to &rarr; Desktop (create shortcut)</em>.',
    'landing.dl.coming':      'Coming soon',

    // === Pricing page ==================================================
    'pricing.hero.eyebrow':   'Pricing &amp; licence',
    'pricing.hero.h1':        'Free on desktop.<br><span class="serif">Paid on iPhone, iPad, Android.</span>',
    'pricing.hero.p':         'Desktop is free, with a soft reminder, until you buy the commercial licence. The mobile and tablet apps are paid up-front in the App Store and Play Store, owning the app once unlocks every feature, no IAP, no subscription.',
    'pricing.beta':           '<strong>Private beta.</strong> Payments are paused until v0.6.0 launches publicly. For now, download the beta build free, the licence dialog accepts a placeholder key. To pre-order the commercial licence and get a key the day issuance flips on, email <a href="mailto:geral@marjers.com">geral@marjers.com</a>.',
    'pricing.t1.name':        'Desktop free',
    'pricing.t1.unit':        'forever',
    'pricing.t1.sub':         'Hobby, learning, home prints, school, anything that doesn\'t get someone else paid. Windows, macOS, Linux.',
    'pricing.t1.cta':         'Download free',
    'pricing.t2.name':        'Mobile &amp; tablet',
    'pricing.t2.unit':        'once',
    'pricing.t2.sub':         'iPhone, iPad, Android phones and tablets. Paid up-front in the App Store and Play Store, no IAP, no subscription, no nag dialog.',
    'pricing.t2.cta':         'Notify me at launch',
    'pricing.t3.name':        'Desktop commercial',
    'pricing.t3.unit':        'once, lifetime',
    'pricing.t3.sub':         'If you sell prints, freelance, or use the desktop build for any paid work. Mobile / tablet already includes commercial rights.',
    'pricing.t3.cta':         'Pre-order, &euro;12',
    'pricing.coffee':         'Coffee tips on top of any tier are welcome at <a href="https://buymeacoffee.com/marjers" target="_blank" rel="noopener" style="color: var(--accent);">buymeacoffee.com/marjers</a>.',
    'pricing.biz.eyebrow':    'Teams &amp; site licences',
    'pricing.biz.h2':         'Buying for a company? <span class="serif">Volume pricing here.</span>',
    'pricing.biz.p':          'If you\'re deploying BlockBuilder Studio in an office, a school lab, or a manufacturing floor, the desktop build detects Windows Pro, Enterprise, Education, or a domain / Azure AD joined machine and prompts for a Business licence instead of the personal one. WinRAR-style, no surveillance, the check happens locally. Volume discount kicks in at 5 seats.',
    'pricing.biz.seat1':      '1 seat',
    'pricing.biz.seat1.each': '&euro;12 per person',
    'pricing.biz.seat5':      '5 seats',
    'pricing.biz.seat5.each': '&euro;9.80 per person',
    'pricing.biz.seat5.save': 'save 18 %',
    'pricing.biz.seat25':     '25 seats',
    'pricing.biz.seat25.each':'&euro;7.96 per person',
    'pricing.biz.seat25.save':'save 34 %',
    'pricing.biz.seat100':    '100+ seats',
    'pricing.biz.seat100.each':'Site-wide quote',
  ...
  pt: {
    ...
    // === Apoio e licen&ccedil;a (landing) =================================
    'landing.support.eyebrow':'Apoio e licen&ccedil;a',
    'landing.support.h2':     'Gr&aacute;tis para sempre.<br><span class="serif">Tr&ecirc;s formas de retribuir.</span>',
    'landing.support.p':      'O BlockBuilder Studio &eacute; um projecto de uma s&oacute; pessoa. Vai sempre funcionar de gra&ccedil;a. Se ganhar o seu lugar na tua m&aacute;quina, eis como o manter vivo.',
    'landing.support.t1.name':'Usa de gra&ccedil;a',
    'landing.support.t1.unit':'/ para sempre',
    'landing.support.t1.sub': 'Hobby, aprender, imprimir em casa, sala de aula, sem conta, sem prazo, todas as funcionalidades.',
    'landing.support.t1.li1': 'Todas as funcionalidades desbloqueadas',
    'landing.support.t1.li2': 'STL &middot; OBJ &middot; STEP sem limite',
    'landing.support.t1.li3': 'Actualiza&ccedil;&otilde;es gr&aacute;tis para sempre',
    'landing.support.t1.li4': 'Lembrete suave a cada 25 lan&ccedil;amentos',
    'landing.support.t1.cta': 'Descarregar gr&aacute;tis',
    'landing.support.t2.name':'Compra-me um caf&eacute;',
    'landing.support.t2.unit':'pontual &middot; valor &agrave; escolha',
    'landing.support.t2.sub': 'Para utilizadores pessoais que queiram contribuir. Sem direitos comerciais, s&oacute; um obrigado que mant&eacute;m o projecto a andar.',
    'landing.support.t2.li1': 'Escolhe o valor (&euro;3, &euro;5, &euro;10&hellip;)',
    'landing.support.t2.li2': 'Financia novas funcionalidades e correc&ccedil;&otilde;es',
    'landing.support.t2.li3': 'Pontual, sem subscri&ccedil;&atilde;o, sem conta',
    'landing.support.t2.li4': 'Agradecimento honesto, n&atilde;o licenciamento',
    'landing.support.t2.cta': '&#x2615; Compra-me um caf&eacute;',
    'landing.support.t3.name':'Licen&ccedil;a comercial',
    'landing.support.t3.unit':'uma vez &middot; para a vida',
    'landing.support.t3.sub': 'Se vendes impress&otilde;es, fazes freelance ou usas em trabalho pago. Tamb&eacute;m o n&iacute;vel mais alto de apoio.',
    'landing.support.t3.li1': '<strong>Direitos de uso comercial</strong>, vender, freelance, ag&ecirc;ncia',
    'landing.support.t3.li2': 'Desliga o lembrete suave da app',
    'landing.support.t3.li3': 'Apoio priorit&aacute;rio por email &middot; resposta em 48h',
    'landing.support.t3.li4': 'Todas as m&aacute;quinas que tens, actualiza&ccedil;&otilde;es para a vida',
    'landing.support.t3.li5': '<strong>Financia o pr&oacute;ximo trabalho</strong>, igual ao caf&eacute; mas em c&acirc;neca',
    'landing.support.t3.cta': 'Comprar licen&ccedil;a, &euro;12',
    'landing.support.why':    '<strong>Porqu&ecirc; pedir?</strong> O BlockBuilder Studio &eacute; feito por uma pessoa &agrave;s noites e fins-de-semana. Sem dinheiro de VC, sem venda dos teus dados financiada por analytics, sem upsells. Os &euro;12 da licen&ccedil;a e os caf&eacute;s s&atilde;o como continua vivo sem se tornar o WinRAR (j&aacute; sabes o di&aacute;logo). Escolhe o que melhor encaixa em como usas.',

    // === Download section (landing) =====================================
    'landing.dl.eyebrow':     'Descarregar &middot; v0.6.0-beta1 &middot; ~105 MB',
    'landing.dl.h2':          'Escolhe o teu OS.<br><span class="serif">Um clique. Sessenta segundos.</span>',
    'landing.dl.p':           'Sem email, sem registo, sem lista de espera. O descarregamento come&ccedil;a imediatamente.',
    'landing.dl.mobile.h':    'Est&aacute;s num telem&oacute;vel ou tablet?',
    'landing.dl.mobile.p':    'Salta o descarregamento, abre a app no browser:',
    'landing.dl.mobile.cta':  'Abrir o BlockBuilder no browser &rarr;',
    'landing.dl.mobile.note': 'Optimizado para tablet e telem&oacute;vel. Funciona offline depois da primeira visita. Adicionar &agrave; Home Screen para ter &iacute;cone de app.',
    'landing.dl.win.os':      'Windows 10 &middot; 11',
    'landing.dl.win.file':    'BlockBuilderStudio-v0.6.0-beta1-portable.zip',
    'landing.dl.win.meta':    '105 MB &middot; Port&aacute;til &middot; Descompactar e correr',
    'landing.dl.mac.os':      'macOS 12+',
    'landing.dl.mac.file':    'Em breve',
    'landing.dl.mac.meta':    'Universal &middot; Intel + Apple Silicon',
    'landing.dl.linux.os':    'Linux x64',
    'landing.dl.linux.file':  'Em breve',
    'landing.dl.linux.meta':  'AppImage &middot; Sem instala&ccedil;&atilde;o',
    'landing.dl.foot':        '<span class="mono" style="color: var(--text-mid);">v0.6.0</span> &middot; Lan&ccedil;ado em Junho 2026 &middot; C&oacute;digo no <a href="https://github.com/josedasilva11/blockbuilder-studio" target="_blank" rel="noopener">GitHub</a> &middot; <a href="/changelog">Notas de vers&atilde;o &rarr;</a>',
    'landing.dl.smart':       'O SmartScreen do Windows pode mostrar um aviso no primeiro lan&ccedil;amento (bin&aacute;rio ainda n&atilde;o assinado). Clica <strong>Mais informa&ccedil;&otilde;es &rarr; Executar mesmo assim</strong>. <a href="https://github.com/josedasilva11/blockbuilder-studio#why-the-smartscreen-warning" target="_blank" rel="noopener">Porqu&ecirc;?</a>',
    'landing.dl.sys.win.h':   'Windows',
    'landing.dl.sys.win.p':   '10 / 11 &middot; x64 &middot; 4 GB RAM &middot; WebGL2 (a maioria das gr&aacute;ficas integradas a partir de 2015)',
    'landing.dl.sys.mac.h':   'macOS',
    'landing.dl.sys.mac.p':   '12 Monterey ou superior &middot; Intel x64 ou Apple Silicon (M1+)',
    'landing.dl.sys.linux.h': 'Linux',
    'landing.dl.sys.linux.p': 'Ubuntu 22.04+ / Fedora 38+ / Arch / qualquer distro com FUSE',
    'landing.dl.post.h':      'Depois do descarregamento, tr&ecirc;s passos',
    'landing.dl.post.s1.h':   'Extrai o .zip',
    'landing.dl.post.s1.p':   'Bot&atilde;o direito em <code>BlockBuilderStudio-v0.6.0-beta1-portable.zip</code> &rarr; <strong>Extrair tudo&hellip;</strong> (ou usa o 7-Zip). Escolhe qualquer pasta, Ambiente de trabalho, Documentos, qualquer s&iacute;tio com permiss&atilde;o de escrita.',
    'landing.dl.post.s2.h':   'Corre BlockBuilder Studio.exe',
    'landing.dl.post.s2.p':   'Abre a pasta <code>BlockBuilderStudio</code> extra&iacute;da. Duplo-clique em <strong>BlockBuilder Studio.exe</strong>. No primeiro arranque o SmartScreen do Windows pode dizer <em>"O Windows protegeu o teu PC"</em>, clica <strong>Mais informa&ccedil;&otilde;es &rarr; Executar mesmo assim</strong>.',
    'landing.dl.post.s3.h':   'E pronto, come&ccedil;a a modelar',
    'landing.dl.post.s3.p':   'Sem instalador. Nada em <code>Program Files</code>, sem chaves de registo, sem atalhos a menos que cries um. Para desinstalar: apaga a pasta. Para actualizar: descarrega a pr&oacute;xima vers&atilde;o e substitui.',
    'landing.dl.post.tip':    '<strong>Queres um atalho no ambiente de trabalho?</strong> Bot&atilde;o direito em <code>BlockBuilder Studio.exe</code> &rarr; <em>Enviar para &rarr; Ambiente de trabalho (criar atalho)</em>.',
    'landing.dl.coming':      'Em breve',

    // === Pricing page ==================================================
    'pricing.hero.eyebrow':   'Pre&ccedil;os e licen&ccedil;a',
    'pricing.hero.h1':        'Gr&aacute;tis em desktop.<br><span class="serif">Pago em iPhone, iPad, Android.</span>',
    'pricing.hero.p':         'O desktop &eacute; gr&aacute;tis, com um lembrete suave, at&eacute; comprares a licen&ccedil;a comercial. As apps de telem&oacute;vel e tablet s&atilde;o pagas &agrave; cabe&ccedil;a na App Store e Play Store, pagar uma vez desbloqueia tudo, sem IAP, sem subscri&ccedil;&atilde;o.',
    'pricing.beta':           '<strong>Beta privada.</strong> Os pagamentos est&atilde;o em pausa at&eacute; o v0.6.0 sair publicamente. Por agora, descarrega o build beta gr&aacute;tis, o di&aacute;logo de licen&ccedil;a aceita uma chave placeholder. Para pr&eacute;-comprar a licen&ccedil;a comercial e receber a chave no dia em que abrirem, email <a href="mailto:geral@marjers.com">geral@marjers.com</a>.',
    'pricing.t1.name':        'Desktop gr&aacute;tis',
    'pricing.t1.unit':        'para sempre',
    'pricing.t1.sub':         'Hobby, aprender, impress&otilde;es em casa, escola, tudo o que n&atilde;o paga a ningu&eacute;m. Windows, macOS, Linux.',
    'pricing.t1.cta':         'Descarregar gr&aacute;tis',
    'pricing.t2.name':        'Telem&oacute;vel e tablet',
    'pricing.t2.unit':        'uma vez',
    'pricing.t2.sub':         'iPhone, iPad, telem&oacute;veis e tablets Android. Pagos &agrave; cabe&ccedil;a na App Store e Play Store, sem IAP, sem subscri&ccedil;&atilde;o, sem di&aacute;logo de chato.',
    'pricing.t2.cta':         'Avisar no lan&ccedil;amento',
    'pricing.t3.name':        'Desktop comercial',
    'pricing.t3.unit':        'uma vez, para a vida',
    'pricing.t3.sub':         'Se vendes impress&otilde;es, fazes freelance ou usas o build desktop para qualquer trabalho pago. Mobile / tablet j&aacute; inclui direitos comerciais.',
    'pricing.t3.cta':         'Pr&eacute;-comprar, &euro;12',
    'pricing.coffee':         'Caf&eacute;zinhos por cima de qualquer plano s&atilde;o bem-vindos em <a href="https://buymeacoffee.com/marjers" target="_blank" rel="noopener" style="color: var(--accent);">buymeacoffee.com/marjers</a>.',
    'pricing.biz.eyebrow':    'Equipas e licen&ccedil;as colectivas',
    'pricing.biz.h2':         'Vais comprar para uma empresa? <span class="serif">Pre&ccedil;os por volume aqui.</span>',
    'pricing.biz.p':          'Se est&aacute;s a implantar o BlockBuilder Studio num escrit&oacute;rio, laborat&oacute;rio escolar ou ch&atilde;o de f&aacute;brica, o build desktop detecta Windows Pro, Enterprise, Education ou m&aacute;quina ligada a dom&iacute;nio / Azure AD e pede uma licen&ccedil;a Business em vez da pessoal. Estilo WinRAR, sem vigil&acirc;ncia, a verifica&ccedil;&atilde;o &eacute; local. Desconto por volume come&ccedil;a aos 5 lugares.',
    'pricing.biz.seat1':      '1 lugar',
    'pricing.biz.seat1.each': '&euro;12 por pessoa',
    'pricing.biz.seat5':      '5 lugares',
    'pricing.biz.seat5.each': '&euro;9,80 por pessoa',
    'pricing.biz.seat5.save': 'poupa 18 %',
    'pricing.biz.seat25':     '25 lugares',
    'pricing.biz.seat25.each':'&euro;7,96 por pessoa',
    'pricing.biz.seat25.save':'poupa 34 %',
    'pricing.biz.seat100':    '100+ lugares',
    'pricing.biz.seat100.each':'Or&ccedil;amento global',
